module.exports = async (client) => {
    client.on('guildMemberUpdate', async (o, n) => {
        if(o.guild.id !== '1156169360050749471') return;
       ...
       await client.channels.cache.get(`1290541153996902411`).send(`Auto Noprefix Added To ${n} With Reason : \`Boosted The Server\``)
            }
            if (before && !after) {
                await client.db.pull(`noprefix_${client.user.id}`,o.id)       
                await client.channels.cache.get(`1290541153996902411`).send(`Auto Noprefix Removed To ${o} With Reason : \`Removed The Boost\``)
